...
#### 7. [시스템](#-system)
#### 8. [스토리보드](#-storyboard)
#### 9. [요구사항 및 진행사항](#-progress--requirements)
...
### ☞ Sub concept2
 - emotion (감정)
     <pre>설명 : 게임 속에서 플레이어는 게임내의 주인공의 이야기를 찾아가며, 그 이야기를 통해 여러 감정을 느끼게 합니다.</pre>     
...
# ▷ Storyboard
   - [스토리보드 개별 문서 ](/Storybord.md)
------------------------------------------------------------------------------    

# ▷ [Progress & Requirements](/Progress.md)
  - [진행사항및 요구사항은 개별 문서 참고](/Progress)
